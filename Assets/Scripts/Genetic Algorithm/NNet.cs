...
{
    public Matrix<float> inputLayer = Matrix<float>.Build.Dense(1, 18);
    ...
    public void Initialise(int hiddenLayerCount, int hiddenNeuronCount)
    {
        ...
        for (int i = 0; i < hiddenLayerCount + 1; i++)
        {
            ...
            if (i == 0)
            {
                Matrix<float> inputToH1 = Matrix<float>.Build.Dense(18, hiddenNeuronCount);
    ...
    public (float, float) RunNetwork (List<float> sensors)
    {
        for (int i = 0; i < 11; i++)
        {
