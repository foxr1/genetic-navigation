...
//    {
//        timeSinceStart += (double)Time.unscaledDeltaTime;

//        //if (currentGeneration % 10 == 0)
//        //{
//        //    SaveGeneration(Application.persistentDataPath + "/" + "Genetic Save");
//        //}
//    }
...
//    //        PopulationGenes = new List<T[]>(population.Length)
//    //    };

//    //    for (int i = 0; i < population.Length; i++)
//    //    {
//    //        save.PopulationGenes.Add(new T[population[i].biases.Count]);
//    //        Array.Copy(population[i].biases, save.PopulationGenes[i], population[i].biases.Count);
//    //    }
...
//    //    currentGeneration = save.Generation;
...
//    //            //population.
//    //        }
//    //        Array.Copy(save.PopulationGenes[i], population[i].biases, population[i].biases.Count);
//    //    }
